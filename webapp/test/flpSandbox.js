					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DMS Sample Application",
									"targetURL": "#comagagdms-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comagagdms-display": {
								"semanticObject": "comagagdms",
								"action": "display",
								"description": "DMS Sample Application",
								"title": "DMS Sample Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ag.agdms",
									"url": sap.ui.require.toUrl("com/ag/agdms")
								}
							}
						}
					}
